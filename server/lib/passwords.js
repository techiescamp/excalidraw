...
export const PASSWORD_GUIDANCE = 'Use 8–128 characters. Spaces and Unicode are welcome. Avoid common or compromised passwords.';
...
export function validatePassword(value) {
 if(typeof value !== 'string' || [...value].length < 8 || [...value].length > 128) fail(400,PASSWORD_GUIDANCE);
